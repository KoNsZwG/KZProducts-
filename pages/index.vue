    ...
    <section class="relative overflow-hidden">
      <div class="container relative py-24 lg:py-32">
        <div class="text-center space-y-8 max-w-4xl mx-auto">
          <!-- Gradient Title -->
          <h1
            class="text-4xl font-extrabold tracking-tight sm:text-5xl lg:text-6xl bg-gradient-to-r from-white via-white to-violet-400 bg-clip-text text-transparent"
          >
        ...
        <!-- Animated Beam Visualization - Full Width -->
        <div class="mt-8">
          <HeroAnimatedBeam />
        </div>
      </div>
