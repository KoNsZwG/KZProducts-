...
<template>
  <div class="container py-8 max-w-4xl">
    ...
    <div v-if="items.length === 0" class="text-center py-20 border rounded-lg bg-muted/20">
    ...
    <div v-else class="grid md:grid-cols-3 gap-8">
      ...
      <div class="md:col-span-2 space-y-4">
        <div v-for="item in items" :key="item.productId" class="flex gap-4 p-4 border rounded-lg bg-card">
          ...
          <div class="flex-1 flex flex-col justify-between">
            ...
            <div class="flex items-center justify-between mt-2">
               ...
               <Button variant="ghost" size="icon" @click="removeFromCart(item.productId)" class="text-destructive hover:text-destructive/80 hover:bg-destructive/10">
